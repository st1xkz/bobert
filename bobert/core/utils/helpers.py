...
def get_role_permission_names():
    return {
        ...
        hikari.Permissions.MANAGE_GUILD_EXPRESSIONS: "Manage Expressions",
        ...
        # hikari.Permissions.SEND_POLLS: "Create Polls",
        ...
        # hikari.Permissions.USE_EXTERNAL_APPS: "Use External Apps",
